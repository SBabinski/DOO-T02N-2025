...
public class Assistidas implements IGerenciadorDeSeries {
    ...
    public void adicionar(Series serie) {
        if (!lista.contains(serie)) {
            ...
            System.out.println("A série '" + serie.getName() + "' já está na lista de assistidas.");
        }
    }
    ...
    public void remover(int idSerie) {
        ...
        if (removed) {
            System.out.println("Série com ID " + idSerie + " removida das assistidas.");
        } else {
    ...
    public void listarOrdenado(int criterio) {
        ...
        System.out.println("\n--- Séries Assistidas (" + getCriterionName(criterio) + ") ---");
