...
public class Favoritos implements IGerenciadorDeSeries {
    ...
    public void adicionar(Series serie) {
        if (!lista.contains(serie)) {
            ...
            System.out.println("A série '" + serie.getName() + "' já está na lista de favoritos.");
        }
    }
    ...
    public void remover(int idSerie) {
        ...
        if (removed) {
            System.out.println("Série com ID " + idSerie + " removida dos favoritos.");
        } else {
    ...
    public void listarOrdenado(int criterio) {
        ...
        System.out.println("\n--- Séries Favoritas (" + getCriterionName(criterio) + ") ---");
